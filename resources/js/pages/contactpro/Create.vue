                        ...
                        <div class="border-b border-gray-200 bg-white p-6">
                            ...
                            <form @submit.prevent="submit" class="space-y-6">
                                ...
                                <div class="">
                                    ...
                                    />
                                    <div
                                        v-if="form.errors.professionnel_id"
                                        class="mt-1 text-sm text-red-600"
                                    >
                                        {{ form.errors.professionnel_id }}
                                    </div>
                                </div>
                                <div class="">
                                    <label
                                ...
                                <button
                                    ...
                                    class="rounded bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                                >
